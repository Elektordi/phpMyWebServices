...
$functionname = "CrashTest"; // Put the same name as the fn_ and op_ files !
$servicename = "Test1"; // Put the WebServiceCode here (like in ws_conf) !

$returntype = "null";	// The type of the return... Take a look at the help for type list... Custom types not supported yet !

$args_num = 0; // Numbers of parameters. 0=No parameters
